...
import { PurchaseHistoryController } from "../controller/controller";
...
router.get("/", async (req, res) => {
    try{
      ...
      let purchaseHistoryResponse = await controller.getPurchaseHistory(limit, offset)
      let purchaseHistoryCount = await controller.getPurchaseHistoryCount()
