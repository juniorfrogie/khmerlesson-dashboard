...
export function PurchaseHistoryForm({
  data,
  onRefundSubmit,
  isLoading,
}: PurchaseHistoryFormProps) {
  ...
  const getMainLessons = async ({ queryKey }: any) => {
    ...
    const response = await apiRequest(
      "GET",
      `/api/main-lessons/${data?.mainLessonId}`,
    );
            ...
            <div className="space-y-4">
              {isFetching ? (
                ...
                <div className="space-y-6">
                  {!mainLesson ? (
                    <p className="neutral-light text-sm">
                      No main lesson found
                    </p>
                  ) : (
                    <Card>
                      <CardHeader>
                          ...
                          <div className="flex items-center space-x-4">
                            ...
                            <div>
                              ...
                              <div className="flex items-center space-x-2 mt-3">
                                <Badge
                                  variant={
                                    mainLesson.free ? "default" : "secondary"
                                  }
                                >
                                  {mainLesson.free
                                    ? "Free"
