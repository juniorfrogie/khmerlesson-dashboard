...
import { GraduationCap, BarChart3, BookOpen, HelpCircle, BookType, Library, Users, CreditCard, Package, Bug } from "lucide-react";
...
const navigation = [
  ...
  { key: "debug_logs" as ActiveView, label: "Debug Logs", icon: Bug },
